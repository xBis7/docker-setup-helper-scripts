...
# Hive path
hive_jars_path="$abs_path/$PROJECT_HIVE/packaging/target/apache-hive-4.0.0-bin/apache-hive-4.0.0-bin/lib"
...
hive_generated_entrypoint_path="$abs_path/$PROJECT_HIVE/packaging/target/apache-hive-4.0.0-bin/apache-hive-4.0.0-bin/compose/hive-metastore-ranger"
