...
# Hive path
hive_jars_path="$abs_path/$PROJECT_HIVE/packaging/target/apache-hive-3.1.5-bin/apache-hive-3.1.5-bin/lib"
...
hive_generated_entrypoint_path="$abs_path/$PROJECT_HIVE/packaging/target/apache-hive-3.1.5-bin/apache-hive-3.1.5-bin/compose/hive-metastore-ranger"
