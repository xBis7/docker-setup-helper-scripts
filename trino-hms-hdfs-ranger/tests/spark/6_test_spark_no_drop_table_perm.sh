...
scala_sql=$(base64encode "drop table default.new_spark_test_table")
scala_msg=$(base64encode "Permission denied: user [spark] does not have [DROP] privilege on [default/new_spark_test_table]")
