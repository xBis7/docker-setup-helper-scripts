...
scala_sql=$(base64encode "drop database if exists poc_db cascade")
scala_msg=$(base64encode "Permission denied: user [spark] does not have [DROP] privilege on [poc_db]")
