...
./tests/"$component"/1_test_"$component"_no_hdfs_perms.sh "$abs_path"
...
./tests/"$component"/2_test_"$component"_hdfs_perms_no_hive_perms.sh "$abs_path"

echo ""
echo """### TEST_"$component"_hdfs_hive_all ###"""
./tests/"$component"/3_test_"$component"_hdfs_hive_all.sh "$abs_path"

echo ""
echo """### TEST_"$component"_only_select_perm ###"""
./tests/"$component"/4_test_"$component"_only_select_perm.sh "$abs_path"

echo ""
echo """### TEST_"$component"_select_alter_perm ###"""
./tests/"$component"/5_test_"$component"_select_alter_perm.sh "$abs_path"

echo ""
echo """### TEST_"$component"_no_drop_table_perm ###"""
./tests/"$component"/6_test_"$component"_no_drop_table_perm.sh "$abs_path"

echo ""
echo """### TEST_"$component"_drop_table_perm ###"""
./tests/"$component"/7_test_"$component"_drop_table_perm.sh "$abs_path"

echo ""
echo """### TEST_"$component"_no_select_perm ###"""
./tests/"$component"/8_test_"$component"_no_select_perm.sh "$abs_path"
