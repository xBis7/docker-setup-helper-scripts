...
# It is expected for this test to fail with the permission denied exception with message similar to 'Permission denied: user [postgres] does not have [DROP] privilege on [default/new_trino_test_table]', but it fails with a different error.
