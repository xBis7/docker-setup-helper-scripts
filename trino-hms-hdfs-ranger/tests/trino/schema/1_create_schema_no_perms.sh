...
echo "- INFO: User [postgres] doesn't have HDFS or Hive permissions."
echo "- INFO: Operation should fail."
echo ""

failMsg="Permission denied: user [postgres] does not have [ALL] privilege on [hdfs://namenode/opt/hive/data/$EXTERNAL_DB/external/$EXTERNAL_DB.db]"
